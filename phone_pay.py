...
df = pd.read_csv("C:\\Pulse\\aggregated_transaction.csv")
...
df = pd.read_csv("C:\\Pulse\\aggregated_user.csv")
values = df.values.tolist()
...
df = pd.read_csv("C:\\Pulse\\map_transaction.csv")
values = df.values.tolist()
...
df = pd.read_csv("C:\\Pulse\\map_user.csv")
values = df.values.tolist()
...
df = pd.read_csv("C:\\Pulse\\top_transaction.csv")
values = df.values.tolist()
...
df = pd.read_csv("C:\\Pulse\\top_user.csv")
values = df.values.tolist()
